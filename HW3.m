...
%Note: In general most of your code shoudl go into functions that are
%placed in your repository. Put calls to those functions in this HW3.m
%script so that they answer the questions. 
...
% 2. Write a fucntion which performs smoothing and background subtraction
...
% Identify a case of interest to you where you believe it should be
% possible to extract information from an image using image processing 
% (you don't necessarily have to know how). Provide a sample image (or link
% to one) and a brief desription of the information that could be
% extracted. This could be something from your own research but need not
% be. It isn't required to be biological. 